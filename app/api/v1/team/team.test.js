...
describe('TEAM API v1', () => {
  ...
  describe('POST /api/v1/company/:companyId/team', () => {
    it('should create team for the company', (done) => {
      ...
      chai.request(server)
        .post('/api/v1/company/' + company + '/team')
  ...
  describe('PATCH /api/v1/company/:companyId/team/:teamId', () => {
    it('should edit team for the company', (done) => {
      ...
      chai.request(server)
        .patch('/api/v1/company/' + company + '/team/' + team1)
        .set('Authorization', companyUser.accessToken)
        .send(data)
        .end((err, res) => {
          chai.should().not.exist(err)
  ...
  describe('GET /api/v1/company/:companyId/team', () => {
    it('should get teams for the company', (done) => {
      chai.request(server)
        .get('/api/v1/company/' + company + '/team')
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
  ...
  describe('GET /api/v1/company/:companyId/team/:teamId', () => {
    it('should get teams for the company', (done) => {
      chai.request(server)
        .get('/api/v1/company/' + company + '/team/588079f49b81d0648ec3b000')
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
    ...
    it('should not get teams for the company if not company team',
      (done) => {
        chai.request(server)
          .get('/api/v1/company/' + company + '/team/588079f49b81d0648ec3b003')
          .set('Authorization', companyUser.accessToken)
          .end((err, res) => {
            chai.should().exist(err)
            res.should.have.status(403)
  ...
  describe('delete /api/v1/company/:companyId/team/:teamId', () => {
    it('should delete team for the company', (done) => {
      chai.request(server)
        .delete('/api/v1/company/' + company + '/team/' + team1)
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
