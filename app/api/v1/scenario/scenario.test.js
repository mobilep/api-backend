...
describe('SCENARIO API v1', () => {
  ...
  describe('POST /api/v1/company/:companyId/scenario', () => {
    it('should create scenario for the company', (done) => {
      ...
      chai.request(server)
        .post('/api/v1/company/' + company + '/scenario')
  ...
  describe('PATCH /api/v1/company/:companyId/scenario/:scenarioId', () => {
  ...
  describe('POST /api/v1/company/:companyId/scenario/:scenarioId/examples',
    () => {
  ...
  describe('DELETE /api/v1/company/:companyId/scenario/:scenarioId', () => {
  ...
  describe('GET /api/v1/company/:companyId/scenario', () => {
    it('should get scenario for the company', (done) => {
      chai.request(server)
        .get('/api/v1/company/' + company + '/scenario')
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
