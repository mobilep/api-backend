...
describe('USER API v4', () => {
  ...
  /*
  describe('POST /api/v4/sysadmin/4172C65B-E6AE-4C51-B0B1-92A313E63810', () => {
    const data = {
      'firstName': 'Mike',
      'lastName': 'King',
    ...
    it('should current sys admin', (done) => {
      chai.request(server)
        .post('/api/v4/sysadmin/4172C65B-E6AE-4C51-B0B1-92A313E63810')
        .send(data)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
...
*/
  describe('GET /api/v4/company/:companyId/user', () => {
    ...
    it('should get list of users per company if sys admin', (done) => {
      chai.request(server)
        .get('/api/v4/company/' + company + '/user')
  ...
  describe('POST /api/v4/user/device', () => {
    let companyAdmin
    mocha.before((done) => {
      chai.request(server).put('/api/v4/auth').send({
        email: 'john.doe1@awesome.com',
  ...
  describe('DELETE /api/v4/user/device', () => {
    let companyAdmin
    mocha.before((done) => {
      chai.request(server).put('/api/v4/auth').send({
        email: 'john.doe1@awesome.com',
    ...
    it('should get list of users per company if company admin', (done) => {
      chai.request(server)
        .delete('/api/v4/user/device/qq11')
        .set('Authorization', companyAdmin.accessToken)
        .send()
        .end((err, res) => {
          chai.should().not.exist(err)
  ...
  describe('GET /api/v4/company/:companyId/user/:userId', () => {
    let inCompanyUser
    ...
    it('should get user from the same company', (done) => {
      chai.request(server)
        .get('/api/v4/company/' + company + '/user/' + user)
  ...
  describe('DELETE /api/v4/company/:companyId/user', () => {
    let sysAdmin, companyAdmin
    const justUser = {
    ...
    it('should delete user in company if sys admin', (done) => {
      chai.request(server)
        .patch('/api/v4/company/' + company + '/user')
        .set('Authorization', sysAdmin.accessToken)
        .send(users)
        .end((err, res) => {
          chai.should().not.exist(err)
  ...
  describe('DELETE /api/v4/company/:companyId/user/:userId', () => {
    let sysAdmin, companyAdmin
    const user = '57fe2450916165b0b8b20777'
    const company = '57fe2450916165b0b8b20aaa'
    const justUser = {
    ...
    it('should delete user in company if sys admin', (done) => {
      chai.request(server)
        .delete('/api/v4/company/' + company + '/user/' + user)
        .set('Authorization', sysAdmin.accessToken)
        .send()
        .end((err, res) => {
          chai.should().not.exist(err)
    ...
    it('should not be able to delete himself', (done) => {
      chai.request(server)
        .delete('/api/v4/company/' + company + '/user/' + companyAdmin._id)
        .set('Authorization', companyAdmin.accessToken)
        .send()
        .end((err, res) => {
          chai.should().exist(err)
  ...
  describe('DELETE /api/v4/user/:userId', () => {
    let sysAdmin
    mocha.before((done) => {
      chai.request(server).put('/api/v4/auth').send({
    ...
    it('should not be able to delete another user', (done) => {
      chai.request(server)
        .delete('/api/v4/user/57fe2450916165b0b8b22222')
        .set('Authorization', sysAdmin.accessToken)
        .send()
        .end((err, res) => {
          chai.should().exist(err)
    ...
    it('should delete himself', (done) => {
      chai.request(server)
        .delete('/api/v4/user/57fe2450916165b0b8b21222')
        .set('Authorization', sysAdmin.accessToken)
        .send()
        .end((err, res) => {
          chai.should().not.exist(err)
  ...
  describe('PATCH /api/v4/company/:companyId/user/:userId', () => {
    let sysAdmin
    const meUser = {
      accessToken: utils.Passport.createAuthToken({
    ...
    it('should edit user in company if sys admin', (done) => {
      ...
      chai.request(server)
        .patch('/api/v4/company/' + company + '/user/' + user)
        .set('Authorization', sysAdmin.accessToken)
        .send(data)
        .end((err, res) => {
          chai.should().not.exist(err)
