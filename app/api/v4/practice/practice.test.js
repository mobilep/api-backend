...
describe('Practice API v4', () => {
  ...
  describe(
    'PATCH /api/v4/company/:companyId/scenario/:scenarioId/practices/practiceId',
    () => {
  ...
  describe('GET /api/v4/company/:companyId/scenario/:scenarioId/practice',
    () => {
      it('should get practices list for coach', (done) => {
        chai.request(server)
          .get('/api/v4/company/' + company +
