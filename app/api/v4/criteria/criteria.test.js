...
describe('CRITERIA API v4', () => {
  ...
  describe('POST /api/v4/company/:companyId/criteria', () => {
    it('should create criteria for the company', (done) => {
      ...
      chai.request(server)
        .post('/api/v4/company/' + company + '/criteria')
  ...
  describe('PATCH /api/v4/company/:companyId/criteria/:criteriaId', () => {
    it('should edit criteria for the company', (done) => {
      ...
      chai.request(server)
        .patch('/api/v4/company/' + company + '/criteria/' + criteria1)
        .set('Authorization', companyUser.accessToken)
        .send(data)
        .end((err, res) => {
          chai.should().not.exist(err)
  ...
  describe('GET /api/v4/company/:companyId/criteria', () => {
    it('should get criterias for the company', (done) => {
      chai.request(server)
        .get('/api/v4/company/' + company + '/criteria')
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
  ...
  describe('delete /api/v4/company/:companyId/criteria/:criteriaId', () => {
    it('should delete criteria for the company', (done) => {
      chai.request(server)
        .delete('/api/v4/company/' + company + '/criteria/' + criteria1)
        .set('Authorization', companyUser.accessToken)
        .end((err, res) => {
          chai.should().not.exist(err)
          res.should.have.status(200)
